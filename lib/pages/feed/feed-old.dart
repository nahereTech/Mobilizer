...
// import 'package:nahere/pages/polls/create_polls.dart';
// import 'package:nahere/pages/push_notification/like_notification_screen.dart';
// import 'package:nahere/pages/push_notification/notice_board_screen.dart';
// import 'package:nahere/pages/push_notification/post_notification_screen.dart';
...
//   //           : 'ca-app-pub-5492043635913912/1935594972',
...
//                       //       _showVersionNotification(
//                       //           _storeUrl, state.build_number);
//                       //     }
//                       //   }
...
//                       //         value: state
//                       //             .topFeedResponse.data![0].is_townhall_leader);
//                       //     setState(() {
//                       //       showFloatingButton =
...
//                         AppSharedPreferences.setValue(
//                             key:
//                                 "page_feed_${orgId.toString()}_${groupId.toString()}",
//                             value: jsonEncode(reindexedData));
//                         print(
//                             "Print: ${orgId.toString()} ${groupId.toString()}");
//                         AppSharedPreferences.setValue(
//                             key:
...
//                                                 AppSharedPreferences.setValue(
//                                                     key: 'eventTownhallID',
//                                                     value: item.townhall_id);
//                                                 AppSharedPreferences.setValue(
//                                                     key: 'eventTownhallName',
//                                                     value: item
//                                                         .townhall_display_name);
//                                               }
...
//                                                   _getCachedFeedData(int.parse(
//                                                       item.townhall_id));
//                                                   _getCachedTopData(int.parse(
//                                                       item.townhall_id));
//                                                   int townID =
...
//                                                   print(
//                                                       "Can P: ${item.can_post} ${item.can_post_polls}");
//                                                   setState(() {
...
//                                                               radius: 30.0 -
//                                                                   (30.0 *
//                                                                       item.circle_reduction_percentage /
//                                                                       100),
...
//                                             itemBuilder: (contextz, index) {
//                                               // Get the current time
//                                               DateTime currentTime =
//                                                   DateTime.now();
//                                               int days =
//                                                   0; //days left for polls to end
...
//                                                 'picture': item.post_update_by,
//                                                 'post_update_by': item.fullname,
//                                                 'username': item.pos,
//                                               };
...
//                                                       ? 0
//                                                       : item.like_count;
//                                               if (_containValue(index) ==
//                                                   false) {
//                                                 _isLikeList.add({
//                                                   'like': item.is_liked == "yes"
//                                                       ? true
//                                                       : false,
//                                                   'counts': likeCounts,
//                                                   'index': index
...
//                                                 pollEndTime = DateTime.parse(
//                                                     item.poll_end);
//                                                 hasPollEnded = currentTime
//                                                     .isAfter(pollEndTime);
//                                                 days = DateTime(
//                                                   DateTime.parse(item.poll_end)
//                                                       .year,
//                                                   DateTime.parse(item.poll_end)
//                                                       .month,
//                                                   DateTime.parse(item.poll_end)
...
//                                                                     : '';
//                                                 print(
//                                                     "poll Date: ${item.poll_end}");

//                                                 for (PollOptions poll
//                                                     in item.poll_details!) {
//                                                   optionList.add({
...
//                                                                                             BlocProvider.of<PostsBloc>(context).add(
//                                                                                               BlockUserEvent(subjectID: item.posted_by, req_type: 'block'),
//                                                                                             );
//                                                                                           }
//                                                                                         },
...
//                                                                               Expanded(
//                                                                                 child: Padding(
//                                                                                   padding: const EdgeInsets.only(left: 1, right: 1.0),
//                                                                                   child: Column(
...
//                                                                                                 ),
//                                                                                           Align(
//                                                                                             alignment: item.post_alignment == "ltr" || item.post_alignment == null || item.post_alignment == "" ? Alignment.topLeft : Alignment.topRight,
//                                                                                             child: InkWell(
//                                                                                               onLongPress: () {
...
//                                                                                                   textAlign: item.post_alignment == "rtl" ? TextAlign.right : TextAlign.left,
//                                                                                                 ),
//                                                                                               ),
//                                                                                             ),
//                                                                                           ),
//                                                                                         ],
//                                                                                       ),
//                                                                                       if (imageList.length > 0) ImageSwipe(imageList: imageList),
//                                                                                       if (item.poll == "yes")
...
//                                                                                               hasVoted: hasVoted,
//                                                                                               userVotedOptionId: item.user_option.toString(),
...
//                                                                                                     hasPollEnded = true;
//                                                                                                   });
//                                                                                                   final snackBar = SnackBar(backgroundColor: Color(0xFFcf5555), content: Text("Poll has ended"));
//                                                                                                   ScaffoldMessenger.of(context).showSnackBar(snackBar);
//                                                                                                   return false;
//                                                                                                 } else {
//                                                                                                   BlocProvider.of<PostsBloc>(context).add(
//                                                                                                     PollCastEvent(postID: item.post_id.toString(), optionID: pollOption.id.toString()),
//                                                                                                   );
//                                                                                                   setState(() {
//                                                                                                     hasVoted = true;
//                                                                                                   });
...
//                                                                                           IconButton(
//                                                                                             icon: Icon(
//                                                                                               _isLikeList[index]['like'] == true ? Icons.favorite : Icons.favorite_outline,
//                                                                                               color: _isLikeList[index]['like'] == true ? Colors.red : Colors.grey,
//                                                                                             ),
//                                                                                             onPressed: () {
//                                                                                               setState(() {
//                                                                                                 _clickedID = index;
...
//                                                                                           ),
//                                                                                           GestureDetector(
//                                                                                             onTap: _isLikeList[index]['counts'] == 0
//                                                                                                 ? null
//                                                                                                 : () {
//                                                                                                     BlocProvider.of<PostsBloc>(context).add(GetLikesEvent(
//                                                                                                       post_id: item.post_id,
//                                                                                                     ));
//                                                                                                     print("Index: clicked index ${index}");
//                                                                                                     _pc.open();
//                                                                                                     setState(() {
//                                                                                                       _slideUpTitle = "Likes(${numberFormat(_isLikeList[index]['counts'])})";
//                                                                                                       _showSlideUpFor = "likes";
...
//                                                                                                     });
//                                                                                                   },
//                                                                                             child: Text(numberFormat(_isLikeList[index]['counts']), style: TextStyle(color: Colors.grey)),
//                                                                                           ),
//                                                                                           item.sharelink == ""
//                                                                                               ? SizedBox()
//                                                                                               : IconButton(
...
//                                                                                               });
//                                                                                               BlocProvider.of<PostsBloc>(context).add(
//                                                                                                 DeleteFeedEvent(post_id: item.post_id, posted_by: item.posted_by),
//                                                                                               );
//                                                                                             } else if (choice == 'Block') {
//                                                                                               BlocProvider.of<PostsBloc>(context).add(
//                                                                                                 BlockUserEvent(subjectID: item.posted_by, req_type: 'block'),
...
//                           await Navigator.pushNamed(
//                               context, CreatePost.routeName, arguments: {
//                             'canPost': canPost,
...
//                     : SizedBox(),
//                 SizedBox(
//                     height: showFloatingButton && showSlideUpPanel == false
//                         ? 20
//                         : 0),
//                 // FloatingActionButton(
...
//   void _toggleLike(int key) {
//     print("Print Before: ${key} ${_isLikeList[key]['like']}");

//     setState(() {
//       _isLikeList[key]['counts'] = _isLikeList[key]['like'] == true
//           ? _isLikeList[key]['counts'] - 1
//           : _isLikeList[key]['counts'] + 1;
//       _isLikeList[key]['like'] =
//           _isLikeList[key]['like'] == true ? false : true;
//     });
//     print("Print After ${key} ${_isLikeList[key]['like']}");
//   }
