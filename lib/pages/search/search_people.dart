...
class SearchPeopleScreen extends StatefulWidget {
  ...
  @override
  SearchPeopleScreenState createState() => SearchPeopleScreenState();
}

class SearchPeopleScreenState extends State<SearchPeopleScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      ...
      //   GetPeopleEvent(term: ''),
      // );
      BlocProvider.of<pe.PeopleBloc>(context).add(pe.GetPeopleEvent(term: ''));
    });
    super.initState();
  }
                    ...
                    : Expanded(
                        child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return AppSharedPreferences.getValue(
                                          key: 'followed_id') ==
...
class _MyButtonState extends State<MyButton> {
  ...
  Widget build(BuildContext context) {
    setState(() {
      pressAttention = widget.isFollowing ? true : false;
    });
